...
NAME=();                 OS=();                       CPU=();
NAME+=('ol7arm');        OS+=('Oracle Linux 7');      CPU+=('Ampere');
NAME+=('ol8arm');        OS+=('Oracle Linux 8');      CPU+=('Ampere');
NAME+=('ol9arm');        OS+=('Oracle Linux 9');      CPU+=('Ampere');
NAME+=('ol7x86');        OS+=('Oracle Linux 7');      CPU+=('Intel');
NAME+=('ol8x86');        OS+=('Oracle Linux 8');      CPU+=('Intel');
NAME+=('ol9x86');        OS+=('Oracle Linux 9');      CPU+=('Intel');
NAME+=('ol7amd');        OS+=('Oracle Linux 7');      CPU+=('AMD');
NAME+=('ol8amd');        OS+=('Oracle Linux 8');      CPU+=('AMD');
NAME+=('ol9amd');        OS+=('Oracle Linux 9');      CPU+=('AMD');
